...
public enum Pitch {
	C(1, "C"), C_SHARP(2, "C#", "Db"), D_FLAT(2, "Db", "C#"), D(3, "D"), D_SHARP(
			4, "D#", "Eb"), E_FLAT(4, "Eb", "D#"), E(5, "E", "Fb"), F_FLAT(5,
			"Fb", "E#"), E_SHARP(6, "E#", "F"), F(6, "F", "E#"), F_SHARP(7,
			"F#", "Gb"), G_FLAT(7, "Gb", "F#"), G(8, "G"), G_SHARP(9, "G#",
			"Ab"), A_FLAT(9, "Ab", "G#"), A(10, "A", "Bbb"), B_DOUBLE_FLAT(10,
			"Bbb", "A"), A_SHARP(11, "A#", "Bb"), B_FLAT(11, "Bb", "A#"), B(12,
			"B", "Cb"), B_SHARP(13, "B#", "C"), C_FLAT(12, "Cb", "B");
